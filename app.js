...
const storelocalStrorage = ()=>{
    ...
    const selectedSeatArr = [...selectedSeats].map( seat => [...notOccupiedSeats].indexOf(seat));
...
const updateMovieInfo = ()=>{
    ...
    film.textContent = selectBox.options[selectBox.selectedIndex].innerText.split("(")[0];
